...
cpt_vento = TabularCPD(variable='Vento', variable_card=2, evidence=['Giocare'], evidence_card=[2], values=[[0.95 ,0.85], [0.05, 0.15]])

DAG = bn.make_DAG(edges, CPD=[cpt_giocare, cpt_pioggia, cpt_vento])

result = bn.inference.fit(DAG, variables=['Giocare'], evidence={'Pioggia': 1, 'Vento': 0})